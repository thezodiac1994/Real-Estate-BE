...
for j in soup.findAll('div',attrs={'href':'javascript:void(0);'}):
    ...
    url2="https://www.google.co.in/maps/search/theater+in+"+area_name
    ...
    length=Text.count('null,null,null,null,null,null,1,null,null,null,null,[\"https://www.google.co.in/search?q\\u003d')
    print(str(length))
    obj=re.compile(r'\"Movie Theater')
